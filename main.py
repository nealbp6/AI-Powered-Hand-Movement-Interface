...
def recognize_image():
    global cordinates, can_grab, running
    while True:
        ret, frame = cap.read()
        if not ret:
            break
...
# user
user_size = 5
cordinates = (width // 2, height // 2)
user_rect = pygame.Rect(cordinates[0], cordinates[1], user_size, user_size)
currently_grabbing = False
can_grab = False

# moveable object
rect_cordinates = (None, None)
